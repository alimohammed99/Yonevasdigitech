 ...
 -->
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
            <img class="img-responsive" style="max-width:570px; max-height:200px; min-width:350px; min-height:250px" src="paperbooksimages/{{$data3->image}}" alt="">
...
{{$data3->book_price}}              </span>
              ...
              <ul class="stars d-flex">
                          ...
                          <a class="btn btn-info" style="color:white" href="{{url('read_paper_book_abstract', $data3->id)}}">
              Read Abstract
              </a>
         


<a style="color:white " href="{{url('download_paper_books', $data3->book)}}" class="btn btn-success"> Download   <i class="fa fa-arrow-down"></i></a>
