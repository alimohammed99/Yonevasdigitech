...
.car a:hover {background-color: #ffd700}
.acc a:hover {background-color: #ffd700}
...
<div class="hero_area">
  ...
  <a id="cart" style="color:black; border-radius:; background-color:#ffd700" class="nav-link cart" href="{{url('show_my_cart')}}"><i class="fa fa-shopping-cart"></i> My Cart [ {{$count}} ]  </a>


  <a id="cart" style="color:black; border-radius:; background-color:#ffd700" class="nav-link cart" href="{{url('show_my_books')}}"><i class="fa fa-book"></i> My Library [ {{$purchased_books}} ]  </a>
...
<!-- &nbsp; &nbsp;
  ...
  <section class="blog_section layout_padding">
    ...
    <div class="section-heading">
              <h2>Category: {{$data->category_name}}</h2>
              <br><br>
              ...
              <!-- <form class="form-inline" action="{{url('search_books2')}}" method="get" style="float:right; padding-top:5px">
 ...
 -->
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
            <img class="img-responsive" style="max-width:570px; max-height:200px; min-width:350px; min-height:250px" src="booksimages/{{$data3->image}}" alt="">
...
{{$data3->book_price}}              </span>
              </h4>
            </div>
                   <div class="detail-box">
              <h5>
                Author: {{$data3->book_author}}
              </h5>
              <h6 style="font-size:18px">
                Title: {{$data3->book_title}}
</h6>
              ...
              <ul class="stars d-flex">
                          ...
                          <a class="btn btn-info" style="color:white" href="{{url('read_book_abstract', $data3->id)}}">
              Read Abstract
              </a>
              <form class="form pt-3" action="{{url('addcart', $data3->id)}}" method="POST">
                              @csrf
...
$check = DB::table("purchased_books_tables")->where("user_id", Auth::user()->id)->where("book_id", $data3->book_id)->first();

@endphp

@if($check)

<a style="color:white " href="{{url('users_download_books', $data3->book)}}" class="btn btn-success"> Download   <i class="fa fa-arrow-down"></i></a>
