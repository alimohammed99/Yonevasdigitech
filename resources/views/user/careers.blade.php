...
<!-- &nbsp; &nbsp;
  ...
  <section style="overflow-x:hidden;" class="contact_section layout_padding">
    <div class="container">
                  ...
                  <div class="form-group col-6">
                    ...
                    <!-- <div class="form-group col-6">
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="middle_initial" type="text" placeholder="First letter of your middle name">
        ...
        <label for="price">Marital Status</label> <br>
                <select style="color:tomato" name="marital_status" id="level" class="form-control" >
                  ...
                  <div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="address" type="text" placeholder="Residential address" required="required">
											<!-- <span class="help">If you want your invoices addressed to a company. Leave blank to use your full name.</span> -->
										</div>
									</div>
                  ...
                  <div class="form-group col-6">
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="phone" type="text" placeholder="Enter phone no." required="required">
										</div>
									</div>
                  <div class="form-group col-6">
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="elementay_school" type="text" placeholder="Yonevas, 2022" required="required">
										</div>
									</div>
                  <div class="form-group col-6">
										<label class="col-form-label">Name of Secondary School and year completed</label>
										<div>
											<input class="form-control" name="secondary_school" type="text" placeholder="Yonevas, 2022" required="required">
										</div>
									</div>
                  ...
                  <div class="form-group col-6">
										...
										<div>
											<input class="form-control" type="text" name="higher_institution" placeholder="Yonevas, 2022" required="required">
										</div>
									</div>
                  ...
                  <div class="form-group col-6">
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" type="number" name="previous_employer_phone" placeholder="Employer's phone number" required="required">
										</div>
									</div>
        ...
        <label for="price">Do you have teaching experience?</label> <br>
                <select style="color:tomato" name="teaching_experience" id="level" class="form-control" >
                  ...
                  <div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="years_of_experience" type="number" placeholder="No. of years" required="required">
										</div>
									</div>
