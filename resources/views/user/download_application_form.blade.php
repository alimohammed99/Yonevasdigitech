...
<!-- &nbsp; &nbsp;
  ...
  <section class="blog_section layout_padding">
    ...
    <div class="section-heading">
            ...
            <h5>Click on download form to get the pdf , print out the form and fill it in block
letters.</h5> <br> <br>

@foreach($data as $data)
              <a class="" style="color:white; background-color:#063547; border:2px solid black; padding:15px; border-radius:30px; font-size:17px" href="{{url('users_download_application_form', $data->form)}}">Download Application form <i class="  fa fa-arrow-circle-down"></i></a>
              @endforeach
<br> <br>
            <h5 class="text-danger">Make sure every word is written clearly and easy to read</h5>
            <h5 class="text-danger">After you fill the form, scan it and send to the email at the bottom of the page or support@yonevasdigitech.study</h5>
</section>
