    ...
    <div class="catagory_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
          These are the various Categories under Paper. This section is made available for our Students only.
          </p>
        </div>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="box ">
              <div class="img-box ali">
                ...
                <a href="{{url('books_by_paper_categories', $sub_cat->id)}}"><img class="catlist" src="papercategoriesimage/{{$sub_cat->image}}" alt=""></a>
              </div>
              <div class="detail-box">
                <h5>
                <a id="link" href="{{url('books_by_paper_categories', $sub_cat->id)}}">{{$sub_cat->category_name}}</a>
                </h5>
