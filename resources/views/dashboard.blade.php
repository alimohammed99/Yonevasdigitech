          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link pl-lg-0" href="{{url('/')}}">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{url('categories')}}">Categories</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{url('find_books')}}"> Find Books/Articles</a>
              </li>
              ...
              @if (Route::has('login'))
                    ...
                    <a id="cart" style="color:white; border-radius:20px; background-color:tomato" class="nav-link cart" href="{{url('showcart')}}"><i class="fa fa-shopping-cart"></i> My Cart [  ]  </a>
</li>
                    <x-app-layout>
    ...
    <div class="catagory_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            There are many variations of books at our Library. You can filter them by their Categories.
          </p>
        </div>
          ...
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <ul class="stars d-flex">
                          ...
                          <a class="btn btn-info" style="color:white" href="">
              Read Abstract
              </a>
